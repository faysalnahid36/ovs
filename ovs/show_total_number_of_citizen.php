<?php
	require_once('dbconnect.php');
	 echo "<html>";
		...
		echo "<form>";
		$sql_total_number_of_citizen= "SELECT COUNT(`voter_id`) FROM voter_info";
		
	   $result_total_number_of_citizen = mysqli_query($con, $sql_total_number_of_citizen);
	    echo "<table align = 'center'>";
	   
	    while ($row = $result_total_number_of_citizen->fetch_assoc())  
	    {
