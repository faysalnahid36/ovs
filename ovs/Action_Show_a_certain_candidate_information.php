<?php
	...
	require_once('dbconnect.php');
	 ...
	 echo "<html>";
		...
		$sql_a_certain_candidate_information="SELECT *, floor (datediff(curdate(),date_of_birth)/ 365.249)AS age FROM candidate_info 
		  WHERE candidate_name='".$_POST['candidate_name']."'";
	    $result_a_certain_candidate_information= mysqli_query($con, $sql_a_certain_candidate_information);
	    if($result_a_certain_candidate_information->num_rows > 0)
	    {
	    echo "<table align = 'center'>";
	    echo "<tr><th>Candidate Name</th><th>Candidate Id</th><th>Date of birth</th><th>Age</th><th>Sex</th><th>Area</th></tr>";
	    while ($row = $result_a_certain_candidate_information->fetch_assoc())  
	    {
